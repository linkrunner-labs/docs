...
For example, if you send the event `add_to_cart`, make sure you have mapped your `add_to_cart` event with Meta's **AddToCart** event in the Linkrunner Meta integration settings.
