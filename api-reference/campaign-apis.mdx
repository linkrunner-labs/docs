...
```json
{
    ...
    "link_for_android_users": "https://www.your-android-website.com",
    "link_for_ios_users": "https://www.your-ios-website.com",
    "custom_display_id": "summer-sale-2025"
}
```

**Campaign with Short Link:**
```json
{
    "name": "Summer Sale 2023",
    "deeplink": "https://app.domain.com/promo/summer25",
...
| `link_for_android_users` | string | No | The fallback URL for android users who click your campaign link. Typically points to your website or web application. |
| `link_for_ios_users` | string | No | The fallback URL for ios users who click your campaign link. Typically points to your website or web application. |
...
| `link_for_android_users` | string\|null | The android fallback URL. Will be `null` for short link campaigns. |
| `link_for_ios_users` | string\|null | The android fallback URL. Will be `null` for short link campaigns. |
