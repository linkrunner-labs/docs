...
### 2.1. Create Campaign with Short Link

Create a new campaign with a short link by including the `is_shortlink: true` parameter.
...
```json
{
    ...
    "deeplink": "https://app.domain.com/promo/spring24",
    "link_for_desktop_users": "https://www.your-website.com",
    "custom_display_id": "spring-launch-2024",
    "is_shortlink": true
}
```
...
| link_for_desktop_users | string  | **Optional**. For desktop visitors                   |
| custom_display_id      | string  | **Optional**. Custom identifier for display purposes |
| is_shortlink           | boolean | **Required**. Set to `true` to create a short link   |
...
```json
{
    ...
    "data": {
        "id": 123,
        "name": "Summer Sale 2023",
        "link": "https://app.domain.com/spring-launch-2024",
        "website": null,
