...
<Steps>
  ...
  <Step title="Select your currency">
    Choose between **USD** and **INR**. This determines the currency for all future invoices. Once set, your billing currency cannot be changed from the dashboard — contact [darshil@linkrunner.io](mailto:darshil@linkrunner.io) if you need to update it.
  </Step>
