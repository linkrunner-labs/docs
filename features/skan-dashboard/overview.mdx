...
<AccordionGroup>
  ...
  <Accordion title="Can I see SKAN dashboard even if SKAN configuration is not done on Linkrunner?">
    ...
    Linkrunner analyzes the postbacks received from Apple for the SKAN dashboard. If you've [configured your app to send postbacks to Linkrunner](/features/skadnetwork-integration), data will be shown on the SKAN dashboard.
