...
- The **Admin**, **Owner**, or **Manager** role on that project. Members and
  Influencers cannot mint MCP tokens.
...
2. Click **Claude (MCP)** in the sidebar.
...
Click **Claude (MCP)** in the sidebar to see all active tokens for the
