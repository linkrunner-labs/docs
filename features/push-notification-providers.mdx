...
<Tabs>
  ...
  <Tab title="MoEngage">
    ...
    1. In the campaign's **Content** step, open the [**Navigation**](https://help.moengage.com/hc/en-us/articles/28297425891476-Create-Navigation-DeepLinks-and-Rich-Landing) setting
    2. Select **Deep Linking** and paste your Linkrunner campaign link
    3. Send the campaign as usual

    On tap, MoEngage opens the link, your app receives it, and `handleDeeplink` attributes the open.

    **Using key-value pairs instead:** add custom key-value pairs (for example, `link` = your campaign link) in the campaign. Then implement MoEngage's [push callback](https://developers.moengage.com/hc/en-us/articles/11738008910996-Push-Callback), read the value from the clicked action's key-value pairs, and pass it to `handleDeeplink`.
  </Tab>
</Tabs>
