...
| **Referral link → Install** | Install + referral conversion | Campaign per referral; event column | [Deep link management](/features/deep-link-management); add `?referrer=` to the link; handle it in-app |
