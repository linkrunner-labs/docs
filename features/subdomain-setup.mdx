...
<Tabs>
  ...
  <Tab title="Cloudflare">
    <Warning>
      You **must** turn off Cloudflare's proxy for this record. Set the **Proxy status** to **DNS only** (grey cloud icon). The orange cloud (proxied) mode will interfere with SSL certificate provisioning and cause verification to fail.
    </Warning>
