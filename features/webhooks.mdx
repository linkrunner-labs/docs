...
<Steps>
  <Step title="Open webhook settings">
    In the dashboard, go to **Settings → Data Export**, then select the **Webhooks** tab. You can also [open Webhook settings directly](https://dashboard.linkrunner.io/settings?s=webhooks).
  </Step>
