...
Tokens created with **Read connected ad accounts** get five more tools. They
...
| Tool | Use it for |
|------|------------|
| `get_ad_insights` | Spend, impressions, clicks, CTR, CPC, CPM, reach, frequency, conversions and ROAS as the ad network reports them, at account, campaign, ad set or ad group, or ad level. Optional breakdown by date, device, platform, country, age or gender. |
...
A few things to know when you read these numbers:
