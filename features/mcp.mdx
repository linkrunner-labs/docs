...
Tokens created with **Read connected ad accounts** get four more tools. They
...
| `ad_network_reference` | The list of metrics, breakdowns and entity types each network supports. Claude reads it before its first ad-account question. |
