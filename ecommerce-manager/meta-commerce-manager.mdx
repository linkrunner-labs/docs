...
_Note: Any event you want to send for these actions should be mapped with their respective standard commerce events in the Linkrunner Dashboard. For example, map your custom add to cart event (e.g., **add_to_cart**) with **AddToCart**, your view event (e.g., **item_viewed** or **view_content**) with **ViewContent**, and your payment event (e.g., **FIRST_PAYMENT** or **DEFAULT**) with **Purchase**._
