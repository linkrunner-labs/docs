...
After verifying basic attribution (click → install → signup), you can test remarketing to confirm reengagement and reinstall reattribution are working.
...
- The `handleDeepLink` function from the Linkrunner SDK is implemented. See your SDK usage guide for details.
...
### Test 2: Reinstall Reattribution
