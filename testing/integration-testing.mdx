...
- Complete the [basic test flow](#test-flow-click-%E2%86%92-install-%E2%86%92-signup) above first (click → install → signup).
...
1. **Create a campaign and install the app:** Follow the [basic test flow](#test-flow-click-%E2%86%92-install-%E2%86%92-signup) above to create a campaign, click the link, and install the app.
