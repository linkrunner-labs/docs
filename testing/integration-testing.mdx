...
- The `handleDeepLink` function from the Linkrunner SDK is implemented. Refer to your [SDK guide](/sdk/react-native) for details.
- [Android backup configuration](/sdk/react-native#step-4%3A-android-backup-configuration) is set up (required for reinstall detection on Android).
