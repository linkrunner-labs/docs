...
### Merging Backup Rules (Android 12+)

If you're targeting Android 12 and above, and you already have your own backup rules specified (e.g., `android:dataExtractionRules="@xml/my_rules"`), then manually add the following rules to your existing files:
