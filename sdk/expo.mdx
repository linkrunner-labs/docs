...
<Steps>
  ...
  <Step title="Report consent">
    Pass the values from your Consent Management Platform (CMP) before you call `init`:
    ...
    See [Google Integrated Conversion Measurement](/sdk/react-native#google-integrated-conversion-measurement-optional) in the React Native guide for what each signal means, the TCF Consent Management Platform option, and how to verify the setup.
  </Step>
</Steps>
