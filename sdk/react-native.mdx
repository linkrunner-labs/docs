...
<Note>
On iOS, the same fields are also returned under their old snake_case keys (`campaign_data`, `ad_network`, etc.) as deprecated aliases. Use the camelCase keys above, which work on both Android and iOS.
</Note>
