...
Once your subdomain is active (CNAME verified and SSL active), you are ready for the next step. You can also find your ready-to-paste destination URL on the Domains settings page.
...
<Note>
    A ready-to-paste version of this URL (with your actual subdomain pre-filled) is available on the [Domains settings page](https://dashboard.linkrunner.io/settings?s=domains).
</Note>
