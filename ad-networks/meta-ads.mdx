...
For Meta App Promotion campaigns, you can add the app link directly in Meta Ads Manager. Linkrunner reads the ad creative `app_link` from Meta and returns it from `getAttributionData()`.

1. Open the campaign in [Meta Ads Manager](https://business.facebook.com/adsmanager)
2. Edit the ad creative
3. Add your app link in Meta's deep link or app link field
4. Publish the ad
