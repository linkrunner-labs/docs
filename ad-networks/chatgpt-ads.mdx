...
<Steps>
  <Step title="Turn on deferred deep linking when you create the campaign">
    In the **Create Campaign** form, switch on **Enable Deferred deeplinking?**, then enter the screen you want users to land on.

    ![Enable Deferred deeplinking in the Linkrunner Create Campaign form](/images/chatgpt-ads/linkrunner-chatgpt-deferred-deeplink.webp)
  ...
  <Step title="Paste the campaign link into ChatGPT Ads Manager">
    ...
    ![Where to paste the Linkrunner campaign link and the tracking macros in ChatGPT Ads Manager](/images/chatgpt-ads/chatgpt-ads-manager-ad-group-link-and-macros.webp)
  ...
  <Step title="Add per-ad values, if different ads point at different screens">
