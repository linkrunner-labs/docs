...
| `cc` | Optional. Your own campaign ID. Linkrunner returns this in the `{campaign_id}` and `{cc}` postback macros. If you do not send it, those macros carry Linkrunner's numeric campaign ID. |
