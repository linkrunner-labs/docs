...
The values in braces are **your own platform's macros**, written in whatever syntax your platform uses. This is the template you save on your side, and it is what Linkrunner shows you in your partner dashboard.
