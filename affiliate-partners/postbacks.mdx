...
If your endpoint restricts incoming traffic by source IP, allowlist both reserved Linkrunner production egress addresses:
...
Add both addresses before testing or activating your integration. Linkrunner will confirm when static egress is active for your integration. Until then, use the source IP shared by the Linkrunner team during onboarding.
