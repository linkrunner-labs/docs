...
```
https://partner.example.com/postback?tid={click_id}&postbackKey=YOUR_KEY
```

Do not use `{secret.postbackKey}`. Add fixed keys as plain query parameters in the template.
