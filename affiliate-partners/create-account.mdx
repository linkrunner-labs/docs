...
<Note>
  Linkrunner configures your postbacks after your application is approved. Installs, and signups once set up, are sent automatically. In-app events are sent only after they are mapped. See [Postbacks and Macros](/affiliate-partners/postbacks) for event mapping, supported macros, and IP allowlisting.
</Note>
