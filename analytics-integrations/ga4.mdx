...
<AccordionGroup>
  <Accordion title="Set GA4 Integration in Linkrunner">
  ...
  <Accordion title="Retrieve app instance ID in Linkrunner SDK">
  ...
  <Accordion title="Retrieve GA4 session ID in Linkrunner SDK">
    ...
    <Tabs>
      ...
      <Tab title="React Native">
        ...
        const onSignup = async () => {
            try {
                const gaSessionId = /* Retrieve GA4 session ID from your tracking layer */ null;
  ...
  <Accordion title="Validate the GA4 Integration">
    ...
    >
        <iframe
            ...
            src="https://www.loom.com/embed/028510c9db364c5aa3f135fcb544dd80"
            title="Validate GA4 Integration with Linkrunner"
            frameBorder="0"
