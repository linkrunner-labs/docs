...
- In MoEngage, for user profile with ID `24`, you'll see `lr_campaign` set to `AXb1c2`
...
<Steps>
  ...
  <Step title="Map User Identifiers in SDK">
    ...
    <Info>
      **Important:** Make sure to pass the `user_id` in the `userData` parameter of the signup function of the SDK to match with your MoEngage user profiles.
    </Info>
  ...
  <Step title="Sync with MoEngage (Optional)">
    ...
    - If you see any discrepancy in attributing profiles on MoEngage
